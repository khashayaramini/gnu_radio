...
class test1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_sink_0.set_center_freq(108000000, 0)
        ...
        self.blocks_wavfile_source_0_0 = blocks.wavfile_source('/home/raven/Downloads/img_0170.wav', True)
        ...
        self.connect((self.blocks_wavfile_source_0_0, 0), (self.analog_nbfm_tx_0, 0))
