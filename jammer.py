...
class binary_source_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "binary_source_1")
        ...
        self._freq_msgdigctl_win = qtgui.MsgDigitalNumberControl(lbl='', min_freq_hz=30e6, max_freq_hz=6e9, parent=self, thousands_separator=",", background_color="black", fontColor="white", var_callback=self.set_freq, outputmsgname='freq')
        self._freq_msgdigctl_win.setValue(2.4e9)
        ...
        self.qtgui_edit_box_msg_0 = qtgui.edit_box_msg(qtgui.FLOAT, '2.4e9', 'freq', True, True, 'value', None)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 15e6, 1, 0, 0)
...
def main(top_block_cls=binary_source_1, options=None):
