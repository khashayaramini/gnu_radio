...
class file_source(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "file_source")
        ...
        self.connect((self.digital_ofdm_tx_0_0, 0), (self.blocks_throttle2_0, 0))
